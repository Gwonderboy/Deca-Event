    ...
    <div className="w-screen pb-5">
      ...
      <div className="pl-24">
        ...
        <div className="ml-16 mr-16 mt-2">
              ...
              <div className="w-[300px] h-[100px] mt-2 flex justify-between">
                <button onClick={userLikesEvent}>
                  <span className="hover:text-green-800 text-green-500">
                    <SlLike className="w-[50px] h-[50px]" />
                    <span>
                ...
                <button onClick={userDislikesEvent}>
                  <span className="hover:text-red-800 text-red-500">
                    <SlDislike className="w-[50px] h-[50px]" />
                    <span>
          ...
          <br />
          <div className="w-full bg-gray-100 px-3">
            ...
            <table className="w-full overflow-y-scroll text-gray-500 font-Inter text-xs">
              <thead className="w-full justify-between">
                ...
                <td className=" text-center">DATE PURCHASED</td>
                <td className=" text-center">TOTAL TICKETS</td>
